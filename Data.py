...
def get_data():
    ...
    train_labels,train_pres = load_train_labels()
    test_images = load_test_images()
    test_labels,test_pres = load_test_labels()
    return train_images,train_labels,train_pres,test_images,test_labels,test_pres
